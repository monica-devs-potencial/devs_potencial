<?php
/**
 * POST /api/services/create.php — Requires authentication + CSRF.
 */
...
$stmt = $pdo->prepare(
    'INSERT INTO services
        (title, description, price_text, badge_text, badge_color, whatsapp_link, image_url, sort_order, active)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)'
);
$stmt->execute([$title, $description, $price_text, $badge_text, $badge_color, $whatsapp, $image_url, $sort_order, $active]);
